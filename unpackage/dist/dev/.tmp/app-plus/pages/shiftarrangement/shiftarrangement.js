...

{
        ...
        success: function success(res) {
          ...
          if (res.statusCode == 200) {
            if (res.data.total != 0) {
              ...
              console.log('request success', " at pages\\shiftarrangement\\shiftarrangement.vue:159");
            } else {
              uni.showToast({
                title: '无排班信息',
                icon: 'none',
              ...
              console.log("无排班信息", " at pages\\shiftarrangement\\shiftarrangement.vue:166");
            }
          } else if (res.statusCode == 204) {
            console.log("无排班信息", " at pages\\shiftarrangement\\shiftarrangement.vue:169");
          } else {
            console.log("排班信息获取失败", " at pages\\shiftarrangement\\shiftarrangement.vue:171");
          }
        } });
  ...
  methods: {
    ...
    change: function change(e) {
      console.log('change 返回:', e.fulldate, " at pages\\shiftarrangement\\shiftarrangement.vue:182");
      this.timeData = e;
    },
    toClick: function toClick(e) {
      this.list = [];
      console.log('点击事件', e.fulldate, " at pages\\shiftarrangement\\shiftarrangement.vue:187");
      this.popUp = 'true';
      ...
      for (var i in this.data) {
        ...
        if (new Date(d.start_at).toDateString() == selected.toDateString()) {
          ...
          console.log(data, " at pages\\shiftarrangement\\shiftarrangement.vue:218");
          this.list.push(data);
        }
      }
      this.timeData = e;
